        ...
        <div className="w-[430px] h-[430px] mr-10 flex-shrink-0">
            ...
            <div className="w-full h-full border border-[#eeeeeee] relative">
                ...
                {currentIndex < images.length - 1 && (
                    <button onClick={goNext} className="absolute top-1/2 right-5 translate-y-[-50%] w-[40px] h-[40px] rounded-full bg-[rgba(33,33,33,0.35)] flex items-center justify-center" >
                ...
                {currentIndex > 0 && (
                    <button onClick={goPrev} className="absolute top-1/2 left-5 translate-y-[-50%] w-[40px] h-[40px] rounded-full bg-[rgba(33,33,33,0.35)] flex items-center justify-center" >
